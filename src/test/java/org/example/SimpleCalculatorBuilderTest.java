...
class SimpleCalculatorBuilderTest {
    SimpleCalculatorBuilder calculatorBuilder = SimpleCalculatorBuilder.getInstance();
    @Test
    void test1() {
        ...
        Vector<String> answers = calculatorBuilder.calculate(expressions).build();
